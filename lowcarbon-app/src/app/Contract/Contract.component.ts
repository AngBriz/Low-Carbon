...
export class ContractComponent implements OnInit {
  ...
  maxEmisionCO2 = new FormControl('', Validators.required);

  constructor(public serviceContract: ContractService, fb: FormBuilder) {
    this.myForm = fb.group({
      contractId: this.contractId,
      maxEmisionCO2: this.maxEmisionCO2
    });
  };
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.proyecto.lowcarbon.Contract',
      'contractId': this.contractId.value,
      'maxEmisionCO2': this.maxEmisionCO2.value
    };
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.maxEmisionCO2) {
        formObject.maxEmisionCO2 = result.maxEmisionCO2;
      } else {
        formObject.maxEmisionCO2 = null;
      }
